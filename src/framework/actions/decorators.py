"""
Tool registration decorators for the GAME framework.

This module provides decorators and utilities for registering tools with metadata,
tags, and automatic schema generation. It enables organized, discoverable tool
registration for AI agents.

Context:
- Tools can be tagged by domain (e.g., "file_operations", "database", "read", "market_data",
"risk_management", "compliance")
- Enables creation of specialized agents for different workflows
- Supports audit trails and compliance requirements through metadata
"""

import inspect
from typing import get_type_hints, List, Callable, Dict, Any

# Global registries for tools and tags
tools = {}
tools_by_tag = {}
